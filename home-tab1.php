<div class="tab-content">
            <div class="tab-pane fade show active" id="latest-articles" role="tabpanel" aria-labelledby="latest-articles-tab">
            ...
            <div class="tab-pane fade" id="new-articles" role="tabpanel" aria-labelledby="new-articles-tab">
              <!-- Articles Section -->
              <div class="container">
                <?php
