<div class="mt-0">
    <img src="assets/svg/icon/notifications-active.svg">&nbsp;&nbsp;
    <b class="text-capitalize text-dark font-size-2">What's New</b>
</div>
...
<?php
                ...
                $newArticlesResult = CallAPI($method, $api, $params);
                //var_dump($result);
                if (count($newArticlesResult->folder[0]->article) > 0 || !empty($newArticlesResult->folder[0]->article)) {
                ?>
...
<div class="mt-3">
    <div class="position-relative">
        <div class="mt-0">
           ...
           <?php
                    foreach ($newArticlesResult->article as $key => $value) {
                      $name = $value->name;                      
                    ?>
                <article class="js-slide card card-bordered h-100">
                    ...
                    <a href="<?php echo $articleDir.'/'.$value->id.'/'.clean_and_hyphenate($value->name); ?>">
                        ...
                        <div class="mb-4">
                            ...
                            <?php echo strlen($value->description) > 50 ? limitWord($value->description, 50) : $value->description;?>
                            </p>
                        </div>
                        <div class="row">
...
<?php } else { ?>
    <div>
    <p class="text-dark text-center">No new articles available</p>
    </div>
<?php } ?>
