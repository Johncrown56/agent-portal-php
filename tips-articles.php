<div class="mt-0">
    <img src="assets/svg/icon/magic.svg">&nbsp;&nbsp;
    <b class="text-capitalize text-dark font-size-2">Tips and Tricks</b>
</div>
...
<?php
                ...
                $tipsArticlesResult = CallAPI($method, $api, $params);
                //var_dump($result);
                if (count($tipsArticlesResult->article) > 0 || !empty($tipsArticlesResult->article)) {
                ?>
...
<div class="mt-3">
    <div class="position-relative">
        <div class="mt-0">
           ...
           <?php
                    foreach ($tipsArticlesResult->article as $key => $value) {
                      $name = $value->name;
                    ?>
...
<?php } else { ?>
    <div>
    <p class="text-dark text-center">No tips articles available</p>
    </div>
<?php } ?>
