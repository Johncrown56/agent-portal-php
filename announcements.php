...
<img src="assets/svg/icon/megaphone.svg">&nbsp;&nbsp;
    <b class="text-capitalize text-dark font-size-2">Just In</b>
</div>
...
<?php
                ...
                $annResult = CallAPI($method, $api, $params);
                //var_dump($result);
                if (count($annResult->article) > 0 || !empty($annResult->article)) {
                ?>   
...
<div class="mt-3">
    <div class="position-relative">
        <div class="mt-0">
           ...
           <?php
                    foreach ($annResult->article as $key => $value) {
                      $name = $value->name;
                    ?>
                <article class="js-slide card card-bordered h-100">
                    <div class="w-sm-100 w-100 min-h-170rem p-4 transition-3d-hover" href="#">
